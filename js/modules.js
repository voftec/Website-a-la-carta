...
window.CATALOG_VERSION = "2026-09-08.12";
window.MODULES = [
  ...
  { id: "i18n", cat: "core", name: "Languages", tagline: "English + Spanish included - add any other language for $100 each", 
    desc: "The site comes in English and Spanish with a language switcher at the top. Each additional language (French, Italian, German, Dutch...) is +$100: we translate the whole site copy and add it to the switcher.", oneTime: 0, monthly: 0, ext: 0, extNote: "", days: 1, qty: {"label":"Add a language","min":0,"max":12,"unit":100,"unitMonthly":0,"included":["English","Spanish"],"options":["French","Italian","German","Dutch","Portuguese","Japanese","Korean","Mandarin","Arabic","Hindi","Russian","Turkish"]}, preview: "i18n" },
  { id: "capture", cat: "core", name: "Fan Capture (Newsletter)", tagline: "Capture fan emails and grow your list", 
    desc: "Email capture form to build the artist's newsletter list: double opt-in, tagging by interest (tour, AR, merch), connected to Mailchimp / Klaviyo so the team sends campaigns from there - we never store emails ourselves. If fans in the European Union will sign up, the site also needs a 'delete my data' request form to be compliant with GDPR (data protection law) - pick the 'US / LatAm + Europe' option (+$200).", oneTime: 500, monthly: 0, ext: 0, extNote: "Mailchimp / Klaviyo plan - the client picks and pays the plan", days: 2, tier: { label: "Regions", options: [
  ...
  { id: "hosting", cat: "ops", locked: true, name: "Hosting, CDN & Security", tagline: "Static-page hosting included - domain not included", 
    desc: "Hosting is included in the budget: the site is deployed as a static page (Vercel/Cloudflare) with SSL, global CDN and DDoS protection. The custom domain (www.yourdomain.com) is not included in this budget: it is an extra paid and owned by the client (~$10-20/year at a registrar); we connect it to the site.", oneTime: 250, monthly: 0, ext: 0, extNote: "", days: 4, preview: null },
