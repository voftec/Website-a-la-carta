...
window.MODULES = [
  ...
  { id: "capture", cat: "core", name: "Fan Capture (Newsletter)", tagline: "Capture fan emails and grow your list", 
    desc: "Email capture form to build the artist's newsletter list: double opt-in, tagging by interest (tour, AR, merch), connected to Mailchimp / Klaviyo so the team sends campaigns from there - we never store emails ourselves. If fans in the European Union will sign up, the site also needs a 'delete my data' request form to be compliant with GDPR (data protection law) - pick the 'US / LatAm + Europe' option (+$200).", oneTime: 300, monthly: 0, ext: 0, extNote: "Mailchimp / Klaviyo plan - the client picks and pays the plan", days: 2, tier: { label: "Regions", options: [
