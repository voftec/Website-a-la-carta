...
window.CATALOG_VERSION = "2026-09-08.1";
window.MODULES = [
  ...
  { id: "news", cat: "content", name: "News & Announcements", tagline: "Editorial hub", 
    desc: "Article pages, categories, rich embeds, SEO schema, RSS.", oneTime: 100, monthly: 0, ext: 0, extNote: "", days: 7, preview: "news" },
...
window.PRESETS = [
  ...
  { id: "fan", name: "Fan Experience", blurb: "≈ $8k — adds more filters, fan club, rewards, store.",
    modules: ["hero", "hosting", "i18n", "capture", "ar_face", "presave", "countdown", "calendar", "video", "support"] },
